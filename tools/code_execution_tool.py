...
def _execute_remote(
    ...
    try:
        ...
        # Start RPC polling thread.  Wrapped so the thread inherits the turn's
        # approval context + callbacks (see tools.thread_context) — else sandbox
        # RPC tool calls lose approval routing (#33057).
